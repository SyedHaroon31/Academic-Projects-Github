...
//        String loc1=ts.getStop2();
//        ////
//        URL url = null;
//        try {
//            url = new URL("http://maps.googleapis.com/maps/api/geocode/json?address="+loc1+"&sensor=true");
//       
...
//    lat1=String.valueOf(loc.getDouble("lat"));
//    lon1=String.valueOf(loc.getDouble("lng"));
//        }
...
//        
        ...
        setMarkerButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                browser.executeJavaScript("var myLatlng = new google.maps.LatLng(42.3398067,-71.08917170000001);\n" +
...
//                browser.executeJavaScript("var myLatlng = new google.maps.LatLng(42.3504997,-71.1053991);\n" +
//                    "var marker = new google.maps.Marker({\n" +
//                    "    position: myLatlng,\n" +
//                    "    map: map,\n" +
//                    "    title: 'View On Map!'\n" +
//                    "});");
//                browser.executeJavaScript("var myLatlng = new google.maps.LatLng(42.3539038,-71.1337112);\n" +
//                    "var marker = new google.maps.Marker({\n" +
//                    "    position: myLatlng,\n" +
//                    "    map: map,\n" +
//                    "    title: 'View On Map!'\n" +
//                    "});");
//                browser.executeJavaScript("var myLatlng = new google.maps.LatLng(42.3378603,-71.10534640000003);\n" +
//                    "var marker = new google.maps.Marker({\n" +
//                    "    position: myLatlng,\n" +
//                    "    map: map,\n" +
//                    "    title: 'View On Map!'\n" +
